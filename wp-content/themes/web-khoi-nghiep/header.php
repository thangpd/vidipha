...
<div id="wrapper">
	...
	<?php if ( ! is_singular( [ 'product', 'shop' ] ) && ! is_archive() && ! is_front_page() ) {
		get_flatsome_breadcrumbs();
	} elseif ( is_front_page() ) {

		echo '<marquee direction="left" behavior="scroll" scrolldelay="5" scrollamount="5" onmouseover="this.stop();"
             onmouseout="this.start();" align="top"><span
                class="cau-chao">CÔNG TY CỔ PHẦN DƯỢC PHẨM TRUNG ƯƠNG VIDIPHA</span></marquee>';
	} ?>
