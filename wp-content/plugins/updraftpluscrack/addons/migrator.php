	...
	public function updraft_migrate_after_widget() {
		...
		<div class="updraft_migrate_widget_module">
			...
			<div class="updraft_migrate_widget_module_title" onclick="updraft_migrate_widget_toggle(this);">
				<p><span class="dashicons dashicons-upload"></span></span><strong><?php _e('Or, send a backup to another site', 'updraftplus');?></strong></p>
			</div>
		...
		<div class="updraft_migrate_widget_module">
			...
			<div class="updraft_migrate_widget_module_title" onclick="updraft_migrate_widget_toggle(this);">
				<p><span class="dashicons dashicons-download"></span></span><strong><?php _e('Or, receive a backup from a remote site', 'updraftplus');?></strong></p>
			</div>
